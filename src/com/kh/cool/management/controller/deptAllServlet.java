...
/**
 * Servlet implementation class deptAllServlet
 */
@WebServlet("/deptAll.me")
public class deptAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public deptAllServlet() {
        super();
	...
	ArrayList<Member> list = new MemberService().deptAll(radioF);
