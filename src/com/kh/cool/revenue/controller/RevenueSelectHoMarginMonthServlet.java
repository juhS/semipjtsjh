...
/**
 * Servlet implementation class RevenueSelectHoMarginMonthInquiryServlet
 */
@WebServlet("/hoMarginMonth.rv")
public class RevenueSelectHoMarginMonthServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RevenueSelectHoMarginMonthServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BranchRevenue ho = new RevenueService().selectHoMarginMonth(selDate);
