 ...
 */
@WebServlet("/brIncomeListMonth.rv")
public class RevenueSelectBrIncomeListMonthServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RevenueSelectBrIncomeListMonthServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<RevenueStatistics> rsList = new RevenueService().selectBrIncomeListMonth(selBranch);
