...
/**
 * Servlet implementation class RevenueSelectHoMonthInquiry
 */
@WebServlet("/hoIncomeMonth.rv")
public class RevenueSelectHoIncomeMonthServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RevenueSelectHoIncomeMonthServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BranchRevenue ho = new RevenueService().selectHoIncomeMonth(selDate);
