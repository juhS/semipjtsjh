...
/**
 * Servlet implementation class RevenueSelectBranchYearInquiryServlet
 */
@WebServlet("/brIncomeYear.rv")
public class RevenueSelectBrIncomeYearServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RevenueSelectBrIncomeYearServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BranchRevenue br = new RevenueService().selectBrIncomeYear(selDate, selBranch);
