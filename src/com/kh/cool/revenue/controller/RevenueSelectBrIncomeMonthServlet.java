...
/**
 * Servlet implementation class RevenueSelectBranchMonthInquiryServlet
 */
@WebServlet("/brIncomeMonth.rv")
public class RevenueSelectBrIncomeMonthServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RevenueSelectBrIncomeMonthServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//parameter는 문자열로 값 전달됨
				...
				BranchRevenue br = new RevenueService().selectBrIncomeMonth(selDate, selBranch);
