...
/**
 * Servlet implementation class RevenueSelectHoYearInquiry
 */
@WebServlet("/hoIncomeYear.rv")
public class RevenueSelectHoIncomeYearServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RevenueSelectHoIncomeYearServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BranchRevenue ho = new RevenueService().selectHoIncomeYear(selDate);
