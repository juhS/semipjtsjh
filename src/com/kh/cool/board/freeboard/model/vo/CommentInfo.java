...
public class CommentInfo {
	...
	public CommentInfo(int communityCode, String commentContent, Date commentWriteDate, int boardNo, int commentNo,
	...
	public String toString() {
		return "CommentInfo [communityCode=" + communityCode + ", commentContent=" + commentContent
				+ ", commentWriteDate=" + commentWriteDate + ", boardNo=" + boardNo + ", commentNo=" + commentNo
