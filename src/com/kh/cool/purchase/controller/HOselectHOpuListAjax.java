...
/**
 * Servlet implementation class HOselectHOpuListAjax
 */
@WebServlet("/selectHOpuListAjax.pu")
public class HOselectHOpuListAjax extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HOselectHOpuListAjax() {
        super();
